...
![](media/image6.png){width="8.475in" height="0.1763888888888889in"}
...
| 文档版本   | 修订记录                               | 日期           |
+============+========================================+================+
| V1.2       | 增加TX5112/TX521/TX523系列部署章节     | 2023年3月8日   |
+------------+----------------------------------------+----------------+
| V1.3       | 1.                                     | 2023年6月21日  |
|            |   修改8.1章节描述，修改4章节时间结构体 |                |
|            |                                        |                |
|            | 2.  添加                               |                |
|            | 第7章节，修改demo所涉及的所有章节描述  |                |
|            |                                        |                |
|            | 3.                                     |                |
|            |   修改RNE_NET_S结构体，去掉vpInput成员 |                |
|            |                                        |                |
|            | 4.  更新芯片相关型号                   |                |
|            |                                        |                |
|            | 5.  更新所有涉及demo和文件名称的截图   |                |
|            |                                        |                |
|            | 6.  修                                 |                |
|            | 改时间接口注意描述，SIM库为PC运行时间  |                |
|            |                                        |                |
|            | 7.  修改RNE_DRIVER_S成员变量           |                |
|            |                                        |                |
|            | 8.  修改RNE_MPI_TRP_RNE_BLOB成员变量   |                |
|            |                                        |                |
|            | 9.  添加get_weight_cfg_file_demo描述   |                |
|            |                                        |                |
|            | 10.                                    |                |
|            | 修改TS_MPI_TRP_RNE_SetLogLevel传入参数 |                |
|            |                                        |                |
|            | 11. 修改8.1.3章节相关描述              |                |
|            |                                        |                |
|            | 12. 修改5.2章节函数引用                |                |
...
|            | 14. 修改FAQ相关                        |                |
|            |                                        |                |
|            | 15. 添加TX5119DV200、TX5339AV200       |                |
+------------+----------------------------------------+----------------+
| V1.4       | 1.  添加set_input_blobs_addr示例程序   | 2023年10月26日 |
|            |                                        |                |
|            | 2.  添加ts_rne_nn_output.h接口及相关   |                |
|            |                                        |                |
|            | 3.  添加librne_common.a库及相关        |                |
|            |                                        |                |
|            | 4.  修改部分文档描述错误               |                |
|            |                                        |                |
|            | 5.  修改代码相关格式                   |                |
...
|            | 11. 修改9.6章节描述                    |                |
|            |                                        |                |
|            | 12. 修改数据结果RNE_NET_INPUT_TYPE_E   |                |
|            |                                        |                |
|            | 13. 修改RT库结构描述                   |                |
+------------+----------------------------------------+----------------+
| V2.1       | 1\.                                    | 2024年1月19日  |
|            | 新增TX5336x_TX5256x-Lib相关接口介绍。  |                |
|            |                                        |                |
|            | 2\. 新增各芯片支持demo。               |                |
|            |                                        |                |
|            | 3\. 修改ts_rne_vpe.h接口说明。         |                |
|            |                                        |                |
|            | 4\. 新增网络权重使用注意事项。         |                |
|            |                                        |                |
|            | 5\. 新增多核相关接口注意事项。         |                |
+------------+----------------------------------------+----------------+
| V2.2       | 1.  新增TS_MPI_TRP_RNE_SetTimeout接口  | 2024年7月29日  |
+------------+----------------------------------------+----------------+
| V2.3       | 1\. 添加FAQ RNE内存查看小工具          | 2024年8月20日  |
|            |                                        |                |
|            | 2\. 添加FAQ SDK使用注意事项            |                |
|            |                                        |                |
|            | 3\. 修改第六章节demo                   |                |
|            |                                        |                |
|            | 4\.                                    |                |
|            | 添加TS_MPI_TRP_RNE_GetExpectedCore接口 |                |
|            |                                        |                |
|            | 5\. 修改RNE_RecordFile调用             |                |
+------------+----------------------------------------+----------------+
| V3.1       | 增加查看cache status接口               | 2024年9月25日  |
+------------+----------------------------------------+----------------+
...
[1 RNE库介绍 [9](#rne库介绍)](#rne库介绍)

[1.1 库结构 [9](#库结构)](#库结构)

[1.2 RNE-SIM-Lib [10](#rne-sim-lib)](#rne-sim-lib)

[1.3 RNE-RT-Lib [11](#rne-rt-lib)](#rne-rt-lib)

[2 API介绍 [13](#api介绍)](#api介绍)

[2.1 基础接口 [14](#基础接口)](#基础接口)

[2.2 时间接口 [23](#时间接口)](#时间接口)

[2.3 日志接口 [29](#日志接口)](#日志接口)

[2.4 版本接口 [32](#版本接口)](#版本接口)

[2.5 VPE接口 [32](#vpe接口)](#vpe接口)

[2.6 输入输出接口 [34](#输入输出接口)](#输入输出接口)

[2.7 高级内存接口 [37](#高级内存接口)](#高级内存接口)

[2.8 通用算子接口 [43](#通用算子接口)](#通用算子接口)

[2.9 异步相关接口 [47](#异步相关接口)](#异步相关接口)

[2.10 多核相关接口 [49](#多核相关接口)](#多核相关接口)

[3 数据结构 [51](#数据结构)](#数据结构)

[4 典型调用流程图 [67](#典型调用流程图)](#典型调用流程图)

[4.1 典型调用流程图 [67](#典型调用流程图-1)](#典型调用流程图-1)

[4.2 典型流程 [67](#典型流程)](#典型流程)

[4.2.1 设置芯片型号 [67](#设置芯片型号)](#设置芯片型号)

[4.2.2 设置log等级 [68](#设置log等级)](#设置log等级)

[4.2.3 初始化数据结构 [68](#初始化数据结构)](#初始化数据结构)

[4.2.4 打开RNE设备 [68](#打开rne设备)](#打开rne设备)

[4.2.5 初始化网络模型 [68](#初始化网络模型)](#初始化网络模型)

[4.2.6 填充网络输入数据 [69](#填充网络输入数据)](#填充网络输入数据)

[4.2.7 网络推理 [69](#网络推理)](#网络推理)

[4.2.8 dump输出数据 [69](#dump输出数据)](#dump输出数据)

[4.2.9 释放网络 [70](#释放网络)](#释放网络)

[4.2.10 关闭RNE设备 [70](#关闭rne设备)](#关闭rne设备)

[5 重点问题说明 [70](#重点问题说明)](#重点问题说明)

[5.1 存储格式介绍 [70](#存储格式介绍)](#存储格式介绍)

[5.1.1 BLOB_N_H_W_Cstride格式
[70](#blob_n_h_w_cstride格式)](#blob_n_h_w_cstride格式)

[5.1.2 BLOB_N_H_W_C格式 [71](#blob_n_h_w_c格式)](#blob_n_h_w_c格式)

[5.1.3 INT_NHWC格式 [71](#int_nhwc格式)](#int_nhwc格式)

[5.2 如何设置输入数据 [72](#如何设置输入数据)](#如何设置输入数据)

[5.2.1 设置输入数据的方式
[72](#设置输入数据的方式)](#设置输入数据的方式)

[5.2.2 输入数据类型与eInputType对应关系
[72](#输入数据类型与einputtype对应关系)](#输入数据类型与einputtype对应关系)

[5.3 如何解析输出数据 [73](#如何解析输出数据)](#如何解析输出数据)

[5.4 SDK中的BLOBS mem [74](#sdk中的blobs-mem)](#sdk中的blobs-mem)

[5.5 网络权重对齐方式 [74](#网络权重对齐方式)](#网络权重对齐方式)

[5.6 设置网络blobs和权重地址为物理地址
[75](#设置网络blobs和权重地址为物理地址)](#设置网络blobs和权重地址为物理地址)

[5.7 onceload网络推理的注意点
[76](#onceload网络推理的注意点)](#onceload网络推理的注意点)

[6 samples说明 [76](#samples说明)](#samples说明)

[7 部署 [77](#部署)](#部署)

[7.1 PC模拟 [77](#pc模拟)](#pc模拟)

[7.1.1 相关文件说明 [77](#相关文件说明)](#相关文件说明)

[7.1.2 重要步骤说明 [77](#重要步骤说明)](#重要步骤说明)

[7.1.3 samples运行说明 [78](#samples运行说明)](#samples运行说明)

[7.2 TX5368x_TX5339x_TX5335x系列板端部署
[79](#tx5368x_tx5339x_tx5335x系列板端部署)](#tx5368x_tx5339x_tx5335x系列板端部署)

[7.2.1 配置交叉编译环境 [79](#配置交叉编译环境)](#配置交叉编译环境)

[7.2.2 编写应用程序main.c
[80](#编写应用程序main.c)](#编写应用程序main.c)

[7.2.3 交叉编译生成板端部署资源
[80](#交叉编译生成板端部署资源)](#交叉编译生成板端部署资源)

[7.2.4 打开部署工具 [80](#打开部署工具)](#打开部署工具)

[7.2.5 拷贝部署资源到板端部署
[80](#拷贝部署资源到板端部署)](#拷贝部署资源到板端部署)

[7.3 TX510x系列板端部署 [81](#tx510x系列板端部署)](#tx510x系列板端部署)

[7.3.1 环境准备 [81](#环境准备)](#环境准备)

[7.3.2 配置交叉编译环境 [81](#配置交叉编译环境-1)](#配置交叉编译环境-1)

[7.3.3 编写应用程序main.c
[82](#编写应用程序main.c-1)](#编写应用程序main.c-1)

[7.3.4 交叉编译生成板端部署资源
[82](#交叉编译生成板端部署资源-1)](#交叉编译生成板端部署资源-1)

[7.3.5 打开串口调试工具 [82](#打开串口调试工具)](#打开串口调试工具)

[7.3.6 拷贝部署资源到板端部署
[82](#拷贝部署资源到板端部署-1)](#拷贝部署资源到板端部署-1)

[7.4 TX5215x_TX5239x200_TX5239x220_TX5239x300系列板端部署
[83](#tx5215x_tx5239x200_tx5239x220_tx5239x300系列板端部署)](#tx5215x_tx5239x200_tx5239x220_tx5239x300系列板端部署)

[7.5 TX5112x_TX5239x201系列板端部署
[83](#tx5112x_tx5239x201系列板端部署)](#tx5112x_tx5239x201系列板端部署)

[7.6 TX5336x_TX5256x 板端部署
[84](#tx5336x_tx5256x-板端部署)](#tx5336x_tx5256x-板端部署)

[8 FAQ [84](#faq)](#faq)

[8.1 bin2header如何使用？
[84](#bin2header如何使用)](#bin2header如何使用)

[8.2 驱动rne_driver.ko如何加载？
[85](#驱动rne_driver.ko如何加载)](#驱动rne_driver.ko如何加载)

[8.3 rne_simple_forward示例中输出结果的宏开关如何使用？
[85](#rne_simple_forward示例中输出结果的宏开关如何使用)](#rne_simple_forward示例中输出结果的宏开关如何使用)

[8.4 CMakeList与Makefile中连接库有哪些注意事项？
[85](#cmakelist与makefile中连接库有哪些注意事项)](#cmakelist与makefile中连接库有哪些注意事项)

[8.5 SDK接口调用性能优化建议？
[86](#sdk接口调用性能优化建议)](#sdk接口调用性能优化建议)

[8.6 板端常见问题如何解决？
[87](#板端常见问题如何解决)](#板端常见问题如何解决)

[8.7 RNE运行时内存查看工具？
[88](#rne运行时内存查看工具)](#rne运行时内存查看工具)

[8.8 SDK使用注意事项？ [88](#sdk使用注意事项)](#sdk使用注意事项)

# RNE库介绍

RNE库包含模拟库（RNE-SIM-Lib）和板端运行库（RNE-RT-Lib）。

RNE模拟库提供在linux pc下模拟正常网络推理所需的API，方便用户在PC端 构建开发调试NN相关的算法原型，使用户在没有硬件环境的情况下也能进行快速的NN模型算法原型开发。以及模拟调试某些在板端发现的NN相关问题。

RNE板端运行库提供网络在板端推理所需的API，用户可以通过加载运行库，完成在板端的部署。

注：下文提及的库，默认都为RNE库，以TX5368AV200平台示例，下文不再特殊说明。

## 库结构

![a](media/image7.jpeg){width="6.03066491688539in"
height="6.420196850393701in"}
...
<figure>
<img src="media/image9.png" style="width:2.26992in;height:2.45695in" />
<figcaption><p>图 1‑3 include和libs详细结构</p></figcaption>
</figure>
...
<figure>
<img src="media/image10.png" style="width:2.50435in;height:0.91252in" />
<figcaption><p>图 1‑4 Samples详细结构</p></figcaption>
</figure>

如图
1‑4所示，samples共有compiled_model、scripts和rne_simple_foward等文件夹构成，各个文件夹描述如下表所示：
...
图 1‑5 RNE-RT-Lib目录结构

如图
1‑5所示，RNE-RT-Lib由samples、open_source、include、bin和libs等文件夹构成，九个文件夹下对应的内容如下表所示：
...
<figure>
<img src="media/image12.png" style="width:2.48427in;height:2.70071in" />
<figcaption><p>图 1‑6 include和libs详细结构</p></figcaption>
</figure>

根据图
1‑6所示，板端运行库（libs）共有librne_common.a、librne_pal_linux_a53.a和librne_rt_g3.a三个库组成，include中是库对应的头文件，两者的对应关系描述如下表所示：
...
<figcaption><p>图 1‑7 samples详细结构</p></figcaption>
</figure>

根据图
1‑7所示，samples共有compiled_model、scripts和rne_simple_forward等文件夹构成，各个文件夹描述如下表所示：
...
SDK提供了一些不同方面的API，包含基本接口、时间接口、日志接口、版本接口、VPE接口、输入输出接口、高级内存接口、通用算子接口、异步接口、多核相关接口等，涉及到以下头文件。
  ...
  头文件                         API说明
  ------------------------------ --------------------------------------------------------------------
  ts_rne_c_api.h                 包含了NN层的API，提供了与RNE相关的函数和结构体的声明。

  ts_rne_device.h                提供了与RNE设备层相关的API，用于管理和控制RNE设备。

  ts_rne_log.h                   包含了与SDK日志相关的API，用于打印和管理日志信息。

  ts_rne_version.h               提供了获取SDK版本信息的API。

  ts_rne_plat_port.h             定义了SDK底层数据结构，可能包含与平台相关的接口和类型定义。

  ts_rne_time.h                  提供了与SDK时间相关的API，用于获取和处理时间信息。

  ts_rne_type.h                  定义了SDK中使用的一些类型和数据结构。

  ts_rne_nn_input.h              提供了填充NN层输入blobs相关的API，用于准备输入数据。

  ts_rne_nn_output.h             提供了填充NN层输出addr相关的API，用于获取输出数据。

  ts_rne_nn_thread.hpp           用于异步调用多个网络时使用的头文件，提供了多线程相关的功能和接口。

  ts_rne_thread_safe_queue.hpp   用于异步调用多个网络时使用的头文件，提供了线程安全队列的实现。

  ts_rne_vpe.h                   包含了与图像处理和视觉任务相关的函数、结构体或其他类型的声明。

  ts_rne_type.h                  包含了与神经网络推理相关的类型定义、枚举常量等。

  ts_type.h                      包含了与系统或库中使用的一些常见类型相关的定义。
  ---------------------------------------------------------------------------------------------------

注：NN层是RNE设备层的上层，用户一般的使用只需要用到NN层的API，特殊情况下才需要用到底层的RNE设备层API。
...
【参数】
  ...
  -----------------------------------------------------------------------------------
  参数名称   描述![](media/image14.png){width="9.027777777777777e-3in"   输入/输出
...
只针对在编译器编译资源时，使用onceload方式编译的资源文件。

在调用该函数前，需要确保已经成功打开设备，加载了模型，并且准备好权重或者量化数据。
...
【返回值】
  ...
  ----------------------------------------------------------------------------------------------------------
  返回值         ![](media/image14.png){width="9.027777777777777e-3in"
                 height="9.027777777777777e-3in"}描述![](media/image14.png){width="9.027777777777777e-3in"
                 height="9.027777777777777e-3in"}
  -------------- -------------------------------------------------------------------------------------------
...
根据位宽、通道数以及是否拼接，计算内存中数据按通道方向向上对齐后的通道数。

该接口即将废弃，后续该功能将被TS_MPI_TRP_RNE_GetBlobCStride代替。
...
> TS_S32 TS_MPI_TRP_RNE_VpeConvert(TS_RNE_VPE_HD \*vpe_hd, TS_VOID
> \*dst, TS_VOID \*src);
>
> 【参数】
...
注意：VPE相关函数只支持产品TX5336x_TX5256x_TX5256x系列。
...
> TS_S32 TS_MPI_TRP_RNE_FillInputBlob(RNE_NET_S \*net, TS_S32 coreIdx, TS_VOID \*input,
> TS_S32 blobIdx);  
...
1.  TS_S32 TS_MPI_TRP_RNE_FillInputBlobs(RNE_NET_S \*net, TS_S32 coreIdx, TS_VOID \*input);
...
【参数】
  ...
  output        输出output地址（用户自行控制此空间的申请释放）            输入
  ------------------------------------------------------------------------------------
...
【参数】
  ...
  dstBlobs      指向 RNE_NET_S 结构体的指针，表示目标数据的   输入
                Blob 数组。                                   
  ------------------------------------------------------------------------
...
TS_RNE_BOOL TS_MPI_TRP_RNE_SetCommonBlobsMemoryCache(RNE_CACHE_STATUS_S
status);
...
【参数】
  ...
  isNoCached    是否禁用缓存，如果为非零值，则禁用缓存；如果为零值，则启用缓存。   输入
  ---------------------------------------------------------------------------------------------
...
【返回值】
  ...
  非NULL                指向分配的连续物理内存空间的起始地址，此地址为虚拟地址。
  --------------------------------------------------------------------------------
...
2.  TS_VOID \*addr = TS_MPI_TRP_RNE_AllocLinearMemCached(bufSize, 0); 

######## TS_MPI_TRP_RNE_FreeLinearMemCached 
...
【参数】
  ...
  参数名称      描述                                                                        输入/输出
  ------------- --------------------------------------------------------------------------- ------------
  ptr           需要被释放的通过TS_MPI_TRP_RNE_AllocLinearMemCached申请的内存空间的指针。   输入
...
3.  TS_MPI_TRP_RNE_FreeLinearMemCached(addr);
...
> TS_VOID TS_MPI_TRP_RNE_CleanLinearMemCached(TS_VOID \*ptr, TS_SIZE_T
> len);
...
3.  TS_MPI_TRP_RNE_CleanLinearMemCached(addr, bufSize);

4.  TS_MPI_TRP_RNE_FreeLinearMemCached(addr);
...
> TS_VOID TS_MPI_TRP_RNE_InvalidateLinearMemCached(TS_VOID \*ptr,
> TS_SIZE_T len);
...
4.  TS_MPI_TRP_RNE_InvalidateLinearMemCached(addr, bufSize);

5.  TS_MPI_TRP_RNE_FreeLinearMemCached(addr);
...
3.  TS_SIZE_T phyAddr = TS_MPI_TRP_RNE_VirtualToPhysicalAddress(addr);
...
【返回值】
  ...
  返回值                描述
  --------------------- ------------------------------------------------------
  0 \~ MAX              转换后的虚拟地址。MAX为TS_SIZE_T类型能表示的最大值。
...
4.  TS_SIZE_T virAddr =
    TS_MPI_TRP_RNE_PhysicalToVirtualAddress(phyAddr);
...
> TS_S32 TS_MPI_TRP_RNE_SetInputBlobsAddr(RNE_NET_S \*net, TS_VOID
...
![](media/image15.png){width="4.641666666666667in"
...
5.  TS_MPI_TRP_RNE_SetInputBlobsAddr(net\[i\], (TS_VOID \*)virAddr,
    (TS_VOID \*)phyAddr);
...
5.  TS_MPI_TRP_RNE_SetResultBlobsAddr(net\[i\], (TS_VOID \*)virAddr,
    (TS_VOID \*)phyAddr);
...
1.  RNE_GP_LAYER_S \*layersInfo = TS_MPI_TRP_RNE_GetGpLayers(net);  

2.  **if** (NULL == layersInfo) {  

3.  TS_MPI_TRP_RNE_Info(\"layersInfo is NULL\\n\");  
...
1.  **for** (TS_S32 i = 0; i \< layersInfo-\>u32LayersNum; ++i) {  

2.      TS_MPI_TRP_RNE_Info(\"layer id: %d layer name: %s layerType:%d typeName:%s\\n\",  

3.                           layersInfo-\>stpLayerInfo\[i\].s32LayerId,  

4.                           layersInfo-\>stpLayerInfo\[i\].cpLayerName,  

5.                           layersInfo-\>stpLayerInfo\[i\].s32LayerType,  

6.                           layersInfo-\>stpLayerInfo\[i\].cpTypeName);  

7.      **if** (RNE_LAYER_TYPE_TEST_GP == layersInfo-\>stpLayerInfo\[i\].s32LayerType) {  

8.          TS_MPI_TRP_RNE_RegisterGpUserData(net, layersInfo-\>stpLayerInfo\[i\].s32LayerId, (**char** \*)TS_MPI_TRP_RNE_GetResVersion(net));  
...
【参数】
  ...
  extraData       编译器编译网络后传给通用算子层的数据                                                   输入

  userData        [TS_MPI_TRP_RNE_RegisterGpUserData](#ts_mpi_trp_rne_getgplayers)函数调用时注册的数据   输入
  -----------------------------------------------------------------------------------------------------------------------------
...
【返回值】
  ...
  返回值                 描述
  ---------------------- ------------------------------------------------------
  RNE_GP_LAYERS_HD_S\*   所有通用算子层处理函数所在结构体的数组
...
1.  **static** TS_VOID TS_MPI_TRP_RNE_PrintGpLayersList() {  

2.      RNE_GP_LAYERS_HD_S \*layerHd = TS_MPI_TRP_RNE_GetGpLayersHd();  

3.      TS_MPI_TRP_RNE_Info(\"gpLayerTypeNum: %d\\n\", layerHd-\>s32GpLayerTypeNum);  

4.      TS_MPI_TRP_RNE_Info(\"userLayerTypeNum: %d\\n\", layerHd-\>s32UserLayerTypeNum);  

5.      **for** (TS_S32 i = 0; i \< layerHd-\>s32UserLayerTypeNum; ++i) {  

6.          TS_MPI_TRP_RNE_Info(\"user gp layer func: %p\\n\", layerHd-\>fnpGpLayerHd\[i\]);  
...
【参数】
  ...
  gpLayerCallback   通用算子层回调函数，详见定义2.8.5                                  
                    [TS_MPI_TRP_RNE_GpLayerHandler](#_TS_MPI_TRP_RNE_GpLayerHandler)   
  ---------------------------------------------------------------------------------------------------
...
【参数】
  ...
  net                   指向RNE_NET_S结构体的指针，用于传递模型的相关信息和配置
...
1.  RNE_ASYNC_EXECUTOR exe;

2.  int ret = TS_MPI_TRP_RNE_AsyncExecutorBind(&exe, net, priority);  
...
> TS_S32 TS_MPI_TRP_RNE_AsyncExecutorUnbind(RNE_ASYNC_EXECUTOR
> \*asyncEtr);
...
【返回值】
  ...
  返回值          描述
  --------------- ------------------------------------------------------------------------------------------------------------------------------
  RNE_BLOBS_S\*   若返回为NULL，则前向推理出现异常；当state的状态为done时，返回网络的最后结果，等同于函数TS_MPI_TRP_RNE_GetResultBlobs的返回值
...
1.  RNE_ASYNC_EXECUTOR exe\[num\];

2.  RNE_BLOBS_S \*rst= TS_MPI_TRP_RNE_ForwardAsync(&exe\[i\]);  

3.  **if** (NULL == rst) {  

4.  TS_MPI_TRP_RNE_Error(\"net forward error!\\n\");  
...
1.  **typedef** **enum** tsRNE_NET_INPUT_TYPE_E {  

2.      RNE_NET_INPUT_TYPE_FLOAT_HWC=0,

3.      RNE_NET_INPUT_TYPE_FLOAT_CHW=1, 

4.      RNE_NET_INPUT_TYPE_INT_HWC=2, 

5.      RNE_NET_INPUT_TYPE_INT_CHW=3, 

6.      RNE_NET_INPUT_TYPE_FORMAT_RGB0=4,

7.      RNE_NET_INPUT_TYPE_FORMAT_BGR0=5,

8.      RNE_NET_INPUT_TYPE_HWC_GREY=6,  

9.      RNE_NET_INPUT_TYPE_INT_HWCSTRIDE=7, 

10. } RNE_NET_INPUT_TYPE_E;  
...
【成员】
  ...
  成员名称                           描述
  ---------------------------------- -------------------------------------------------
  RNE_NET_INPUT_TYPE_FLOAT_HWC       输入是数据32bit浮点型，形状：\[n:h:w:c\]

  RNE_NET_INPUT_TYPE_FLOAT_CHW       输入是数据32bit浮点型，形状：\[n:c:h:w\]

  RNE_NET_INPUT_TYPE_INT_HWC         输入是数据任意bit整形，形状：\[n:h:w:c\]

  RNE_NET_INPUT_TYPE_INT_CHW         输入是数据任意bit整形，形状：\[n:c:h:w\]

  RNE_NET_INPUT_TYPE_FORMAT_BGR0     输入是数据是 BGRA格式，形状：\[n:h:w:4\]

  RNE_NET_INPUT_TYPE_FORMAT_RGB0     输入是数据是 RGBA格式，形状：\[n:h:w:4\]

  RNE_NET_INPUT_TYPE_HWC_GREY        输入是数据是 GREY格式，形状：\[n:h:w:1\]

  RNE_NET_INPUT_TYPE_INT_HWCSTRIDE   输入是数据任意bit整形，形状：\[n:h:w:c_stride\]
  ------------------------------------------------------------------------------------
...
【成员】
  ...
  RNE_NET_OUTPUT_TYPE_FORMAT_NHWC_TO_NCHW   输出blobs内存转换成NCHW排列格式
  ------------------------------------------------------------------------------
...
【成员】
  ...
  cpDebugLayerName   调试层名字，调式中间层用，只有编译出来的debug版本的网络可以用。若不需要此参数可以置为NULL

  vpGpUserData       通用算子层用户数据列表，只需初始化为NULL即可

  vpInnerNd          内部网络描述，只需初始化为NULL即可

  vpSelfBuf          自定义缓存，若为NULL则使用内部共享缓存；否则使用用户在调用网络init前自己分配的缓存，可以通过接口TS_MPI_TRP_RNE_GetInputBlobs获取每个网络的数据缓存大小
...
1.  RNE_GP_LAYER_S \*TS_MPI_TRP_RNE_GetGpLayers(RNE_NET_S \*net);  

2.  TS_S32 TS_MPI_TRP_RNE_LoadModel(RNE_NET_S \*net);  

3.  TS_VOID TS_MPI_TRP_RNE_UnloadModel(RNE_NET_S \*net);  

4.  TS_S32 TS_MPI_TRP_RNE_OnceLoad(RNE_NET_S \*net);  

5.  RNE_BLOBS_S \*TS_MPI_TRP_RNE_Forward(RNE_NET_S \*net);  

6.  TS_U32 TS_MPI_TRP_RNE_GetInputBlobs(RNE_NET_S \*net);  

7.  RNE_BLOBS_S \*TS_MPI_TRP_RNE_GetResultBlobs(RNE_NET_S \*net);  

8.  RNE_BLOBS_S \*TS_MPI_TRP_RNE_GetInputBlobs(RNE_NET_S \*net);  

9.  RNE_BLOBS_S \*TS_MPI_TRP_RNE_GetHideBlobs(RNE_NET_S \*net);  

10. TS_S32 TS_MPI_TRP_RNE_RegisterGpUserData(RNE_NET_S \*net, TS_S32 layerId, TS_VOID \*userData);

11. **const** TS_CHAR \*TS_MPI_TRP_RNE_GetResVersion(RNE_NET_S \*net);  

12. TS_S64 TS_MPI_TRP_RNE_GetWeightSize(RNE_NET_S \*net);   

13. TS_S64 TS_MPI_TRP_RNE_GetCfgSize(RNE_NET_S \*net);  

14. TS_S32 TS_MPI_TRP_RNE_FillInputBlobs(RNE_NET_S \*net, TS_S32 coreIdx, TS_U8 \*input);  
...
1.  **typedef** **enum** tsRNE_BLOB_FORMAT_E {  

2.      RNE_BLOB_N_H_W_Cstride,  

3.      RNE_BLOB_N_Cn_N_H_W_Cx,  
...
【成员】
  ...
  成员名称                 描述
  ------------------------ ------------------------------------------------------------------------
  RNE_BLOB_N_H_W_Cstride   数据存储按照批次、高度、宽度、通道存储，通道对齐到4、8、16、32、32+4等

  RNE_BLOB_N_Cn_N_H_W_Cx   此方式为硬件存储的方式，数据存储按照批次、高度、宽度、通道存储
...
10.     TS_RNE_BOOL bIsUnsigned;  

11.     TS_RNE_BOOL bIsJoined;  

12.     TS_S32 \*s32pQ;  

13.     TS_FLOAT \*fCoeff;  

14.     RNE_BLOB_FORMAT_E eFormat;
...
1.  **typedef** **struct** tsRNE_BLOBS_S {  

2.      TS_U32 u32NBlob;  

3.      RNE_BLOB_S \*stpBlob;  
...
1.  **typedef** **struct** tsRNE_BIN_DATA_S {  
...
1.  TS_VOID TS_MPI_TRP_RNE_SetLogLevel(RNE_LOG_E logLevel);  

2.  RNE_LOG_E TS_MPI_TRP_RNE_GetLogLevel(TS_VOID);  
...
1.  **typedef** **struct** tsRNE_PORT_ADDR_S {  

2.      TS_SIZE_T szBaseAddr;  

3.      TS_SIZE_T szNNpu;  

4.      TS_SIZE_T szMemPhyAddr;  

5.      TS_SIZE_T szMemVirAddr;  
...
1.  **typedef** **struct** tsRNE_DRIVER_S {  

2.      TS_S32 (\*fnpRneInit)(RNE_PORT_ADDR_S \*port);  

3.      TS_VOID (\*fnpRneFree)();  

4.      TS_VOID (\*fnpRneProcOpt)(TS_VOID \*optional);  

5.      TS_U32 (\*fnpRneIsForwardDone)(TS_S32 npuIdx, TS_S32 timeOutMs);  

6.      TS_VOID (\*fnpRneClearForwardDone)(TS_S32 npuIdx);  
...
【成员】
  ...
  RNE_TYPE_NAME_TX5105CV100   芯片TX5105CV100

  RNE_TYPE_NAME_TX5103CV100   芯片TX5103CV100
  ...
  RNE_TYPE_NAME_TX5368AV200   芯片TX5368AV200

  RNE_TYPE_NAME_TX5339AV200   芯片TX5339AV200

  RNE_TYPE_NAME_TX5335AV200   芯片TX5335AV200

  RNE_TYPE_NAME_TX5215CV200   芯片TX5215CV200

  RNE_TYPE_NAME_TX5215DV200   芯片TX5215DV200

  RNE_TYPE_NAME_TX5215DV300   芯片TX5215DV300

  RNE_TYPE_NAME_TX5215EV300   芯片TX5215EV300

  RNE_TYPE_NAME_TX5239DV200   芯片TX5239DV200

  RNE_TYPE_NAME_TX5239DV220   芯片TX5239DV220

  RNE_TYPE_NAME_TX5239DV300   芯片TX5239DV300

  RNE_TYPE_NAME_TX5112CV201   芯片TX5112CV201

  RNE_TYPE_NAME_TX5112DV201   芯片TX5112DV201

  RNE_TYPE_NAME_TX5112CV300   芯片TX5112CV300

  RNE_TYPE_NAME_TX5112DV300   芯片TX5112DV300

  RNE_TYPE_NAME_TX5239CV201   芯片TX5239CV201

  RNE_TYPE_NAME_TX5239DV201   芯片TX5239DV201

  RNE_TYPE_NAME_TX5336AV200   芯片TX5336AV200

  RNE_TYPE_NAME_TX5256AV200   芯片TX5256AV200
...
1.  TS_S32 TS_MPI_TRP_RNE_AsyncExecutorBind(RNE_ASYNC_EXECUTOR
    \*asyncEtr,

2.  RNE_NET_S \*net, TS_S32 priority);

3.  TS_S32 TS_MPI_TRP_RNE_AsyncExecutorUnbind(RNE_ASYNC_EXECUTOR
    \*asyncEtr);
...
![IMG_256](media/image16.png){width="6.5625in"
...
![C:\\Users\\xiehao\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.Word\\企业微信截图_17319140062066.png](media/image17.png){width="6.636111111111111in"
height="2.5548611111111112in"}

图 ‑1 BLOB_N_H_W_Cstride存储格式

如 图 5‑1 ，假设输入shape为\[N:H:W:C\]，箭头1为C方向,
箭头2为W方向，箭头3为H方向，浅灰色表示pad补0。数据存储在c方向上做stride对齐，c_stride需要调用TS_MPI_TRP_RNE_CStride获得。

注意：文档中提到的\[N:H:W:C_Stride\]格式为BLOB_N_H_W_Cstride格式。

### BLOB_N_H_W_C格式

![C:\\Users\\xiehao\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.Word\\企业微信截图_17319140366870.png](media/image18.png){width="6.69375in"
height="2.283333333333333in"}

图 ‑2 BLOB_N_H_W_C存储格式

如图
5‑2，数据存储在n方向上做stride对齐，c_stride需要调用TS_MPI_TRP_RNE_CStride获得（c_stride=c+c_pad）。内存存储时先存放h
\*w\*c的数据，再存放h\*w\*c_pad， 即n = x时的地址偏移为 x \* h \* w \*
c_stride。
...
<figure>
<img src="media/image19.png" style="width:6.69097in;height:2.21458in"
alt="IMG_256" />
<figcaption><p>图 ‑3 INT_NHWC格式存储</p></figcaption>
</figure>

如 图 5‑3，数据存储在所有方向上无stride对齐，即n = x时的地址偏移为 x \*
h \* w \* c。
...
<figure>
<img src="media/image20.png" style="width:7.01389in;height:3.72431in"
alt="IMG_256" />
<figcaption><p>图 ‑4 eInputType对应关系</p></figcaption>
</figure>
...
<figure>
<img src="media/image21.png" style="width:6.45903in;height:0.99028in"
alt="IMG_256" />
<figcaption><p>图 ‑5 NCHW和NHWC的差异</p></figcaption>
</figure>
...
注意：TX510x系列不支持16bit灰度图模式。

## 如何解析输出数据

<figure>
<img src="media/image22.png" style="width:5.21389in;height:3.09306in"
alt="IMG_256" />
<figcaption><p>图 ‑6 eOutputType对应关系</p></figcaption>
</figure>
...
注意：编码解析推理结果可参考open_source/record_file/ts_rne_record_file.c。

## SDK中的BLOBS mem

<figure>
<img src="media/image23.png" style="width:6.90663in;height:1.80685in"
alt="IMG_256" />
<figcaption><p>图 ‑7 数据流</p></figcaption>
</figure>
...
1.  **static** unsigned **char** \_\_attribute\_\_((aligned(4))) modelWeight\[\] = {  
...
![222222](media/image24.png){width="2.9965277777777777in"
height="1.8958333333333333in"}![1111111](media/image25.png){width="3.5104166666666665in"
height="3.4506944444444443in"}

图 ‑8设置输入blobs地址为物理地址

其中设置网络权重地址为物理地址时，SDK内部将不对[权重对齐](#网络权重对齐方式)做保证，需要用户自行保证。

<figure>
<img src="media/image26.png" style="width:6.84792in;height:1.76458in" />
<figcaption><p>图 ‑9设置输入权重地址为物理地址</p></figcaption>
</figure>
...
onceload 功能参见《TS.Knight-编译仿真性能分析使用指南》Knight
RNE编译器使用说明章节。
...
# samples说明
  ...
  序号   名称                          说明
  ------ ----------------------------- ------------------------------------------------
  1      rne_simple_forward            演示一般网络基本推理的流程。

  2      rne_yolov5_detection          演示yolov5的前处理、推理、后处理的完整流程。

  3      rne_vpe                       演示图片格式转换的流程。

  4      rne_async_forward             演示多网络异步推理的流程。

  5      rne_set_input_blobs_addr      演示用户通过物理地址的方式加载输入数据的流程。

  6      rne_yolov8s_detection         演示yolov8s的前处理、推理、后处理的完整流程。

  7      rne_resnet18_classification   演示resnet18的前处理、推理、后处理的完整流程。
  -------------------------------------------------------------------------------------
  ...
  TX5368x_TX5339x_TX5335x                    1, 5                    1, 2,5,6,7

  TX5215x_TX5239x200_TX5239x220_TX5239x300   1, 5                    1,2, 5,6,7
...
![](media/image27.png){width="6.8493055555555555in"
...
![](media/image28.png){width="6.847916666666666in"
...
![](media/image29.png){width="2.3301126421697287in"
height="1.4606681977252844in"}

![](media/image30.png){width="4.50820428696413in"
height="1.3373884514435697in"}
...
> 参见[章节7.1.3](#samples运行说明)。

执行成功后，会看到以下信息提示，表示交叉编译成功，生成板端资源：

samples/rne_simple_forward/build_linux_a53/Release/rne_simple_forward.elf。

![](media/image31.png){width="4.802083333333333in"
...
![1](media/image32.png){width="5.025935039370078in"
height="1.1775929571303587in"}

可以看到模型运行结果如下图，其结果与PC模拟输出结果一致。

![](media/image33.png){width="4.639403980752406in"
height="1.4457622484689414in"}
...
> 在RNE-RT-Lib目录下，有settings_path_linux.sh脚本。编辑该脚本将tools_dir设置成csky_tools_linux.tar.gz
> 解压后的存放路径（最好是绝对路径），之后source一下就可以。
...
![](media/image34.png){width="2.7753674540682414in"
height="1.0212029746281714in"}

![](media/image35.png){width="3.952076771653543in"
...
![](media/image36.png){width="6.845833333333333in"
height="1.3423611111111111in"}

### 打开串口调试工具

确定micro
usb线是否连接好，然后打开串口调试工具，可以使用SSCOM、SecureCRT或者其他的软件，本示例使用的是SecureCRT。
...
**注：**默认情况下ck804的端口为1025，ck805的端口为1026，请注意核对一下是否与ck804_ddr_init.gdbinit、ck805_load.gdbinit初始化文件中的端口号一致，若不一致则需要修改初始化文件，板端的连接配置请参考《IntelliX
TX510 SDK开发使用指南》。

tx5103_a2_ddrinit_CPU266_AIE204_2f5c31a5.elf
名称可能不同，以发布包的为准。
...
![](media/image37.png){width="5.623889982502187in"
height="3.5745406824146984in"}

然后通过串口调试助手中可以看到模型运行结果如下图，其结果与模拟器输出结果一致。

![](media/image38.png){width="3.0416666666666665in"
...
参考[7.2章节](#tx5368x_tx5339x_tx5335x系列板端部署)。
...
如图 8‑1，单执行脚本，会打印帮助提示信息。

<figure>
<img src="media/image39.png" style="width:4.76042in;height:0.41667in" />
<figcaption><p>图 ‑1 bin2header提示帮助信息</p></figcaption>
</figure>
...
bin_file为被转换成的二进制文件，txt_file为需要被转换的头文件（如图
8‑2），去掉首行和尾行（如图 8‑3）。

示例操作如图 8‑4 bin2header转换示例。

<figure>
<img src="media/image40.png" style="width:5.00833in;height:2.66944in" />
<figcaption><p>图 ‑2带首行和尾行的头文件</p></figcaption>
</figure>

<figure>
<img src="media/image41.png" style="width:4.42917in;height:1.92083in" />
<figcaption><p>图 ‑3去掉首行和尾行的头文件</p></figcaption>
</figure>

<figure>
<img src="media/image42.png" style="width:4.19319in;height:2.62176in" />
<figcaption><p>图 ‑4 bin2header转换示例</p></figcaption>
</figure>
...
RNE模拟库中run_e2e_example.sh脚本执行时，输出的文件默认在samples/rne_simple_forward路径下。

注意：RT库目前只有TX5368x_TX5339x_TX5335x、TX5215x_TX5239x200_TX5239x220_TX5239x300、TX5336x_TX5256x和TX5112x_TX5239x201支持存储文件。
...
<figure>
<img src="media/image43.png" style="width:6.85278in;height:0.43472in" />
<figcaption><p>图 ‑5Makefile注意事项</p></figcaption>
</figure>

CMakeList:

<figure>
<img src="media/image44.png" style="width:4.76993in;height:3.32668in" />
<figcaption><p>图 ‑6 CmakeList.txt注意事项</p></figcaption>
</figure>
...
4)  如果网络可以onceload,
    ...
    功能参见《TS.Knight-编译仿真性能分析使用指南》Knight
    RNE编译器使用说明章节。
...
<figure>
<img src="media/image45.png" style="width:5.19792in;height:1.19792in" />
<figcaption><p>图 ‑7板端内存不够</p></figcaption>
</figure>

上述问题需要放大rne_driver.ko的空间。

<figure>
<img src="media/image46.png" style="width:3.0342in;height:0.93784in" />
<figcaption><p>图 ‑8未注册RNE驱动</p></figcaption>
</figure>

上述问题需要注册RNE驱动。

<figure>
<img src="media/image47.png" style="width:6.52083in;height:0.54167in" />
<figcaption><p>图 ‑9交叉编译工具链与板端不对应</p></figcaption>
</figure>

上述问题需要确认SDK与板端是否对应。

<figure>
<img src="media/image48.png" style="width:6.85139in;height:0.82986in" />
<figcaption><p>图 ‑10存在未注册的软件层</p></figcaption>
</figure>

上述问题需要确认软件层是否存在，或者是否注册。

<figure>
<img src="media/image49.png" style="width:6.85486in;height:1.14722in" />
<figcaption><p>图
‑11芯片型号与cfg资源中的型号类型不一致</p></figcaption>
</figure>

上述问题需要确认SDK目标型号与编译后的资源的型号是否正确。

<figure>
<img src="media/image50.png" style="width:6.85625in;height:0.34375in" />
<figcaption><p>图 ‑12驱动与内核不匹配</p></figcaption>
</figure>
...
<figure>
<img src="media/image51.png" style="width:2.28125in;height:0.54167in" />
<figcaption><p>图 ‑13输出信息</p></figcaption>
</figure>
...
2.  在多进程环境下，使用接口前必须通过调用TS_MPI_TRP_RNE_GetAvailableCore或

TS_MPI_TRP_RNE_GetExpectedCore函数来获取核心，其返回值需为非负数（即≥0）。

3.  确保线程一致性，TS_MPI_TRP_RNE_GetAvailableCore的调用必须与

TS_MPI_TRP_RNE_Forward的调用在同一个线程中。

4.  确保线程一致性，TS_MPI_TRP_RNE_GetExpectedCore的调用必须与

TS_MPI_TRP_RNE_Forward的调用在同一个线程中。

单网络双核方式，每个队列有独立的地址空间，需要指定RNE_NET_S中的s32NTask=2。

> 若编译器实际未对模型分块，SDK实际是单核运行，因此会有Warning日志提醒：The
> model actually runs on a single core.

5.  对于绑定核操作，首先应将s32HoldCore置为1，表示占用npu，再调用TS_MPI_TRP_RNE_GetExpectedCore去获取期
    望绑定的核，当占用当前核时，推理完成后，不会释放此核。
