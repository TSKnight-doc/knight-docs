...
该稀疏方法详情请参见《TS.Knight- `编译仿真性能分析使用指南`_》。
...
RNE编译器进行编译，最终会将模型部署到清微芯片上，后续步骤详情请可见文档《TS.Knight-使用指南综述》，《TS.Knight-量化使用指南》和《TS.Knight- `编译仿真性能分析使用指南`_》。
...
此时会出现pip相应的安装路径，比如miniconda3/envs/quant_tool/bin/pip，说明pip已安装。
...
.. code-block:: json
   ...
   其中，性能评估采取百分制。examples/cls/resnet50_cifar/train_val.py中示例如下：
