...
`1 RNE库介绍 <#rne库介绍>`__ `9 <#rne库介绍>`__

`1.1 库结构 <#库结构>`__ `9 <#库结构>`__

`1.2 RNE-SIM-Lib <#rne-sim-lib>`__ `10 <#rne-sim-lib>`__

`1.3 RNE-RT-Lib <#rne-rt-lib>`__ `11 <#rne-rt-lib>`__

`2 API介绍 <#api介绍>`__ `13 <#api介绍>`__

`2.1 基础接口 <#基础接口>`__ `14 <#基础接口>`__

`2.2 时间接口 <#时间接口>`__ `23 <#时间接口>`__

`2.3 日志接口 <#日志接口>`__ `29 <#日志接口>`__

`2.4 版本接口 <#版本接口>`__ `32 <#版本接口>`__

`2.5 VPE接口 <#vpe接口>`__ `32 <#vpe接口>`__

`2.6 输入输出接口 <#输入输出接口>`__ `34 <#输入输出接口>`__

`2.7 高级内存接口 <#高级内存接口>`__ `37 <#高级内存接口>`__

`2.8 通用算子接口 <#通用算子接口>`__ `43 <#通用算子接口>`__

`2.9 异步相关接口 <#异步相关接口>`__ `47 <#异步相关接口>`__

`2.10 多核相关接口 <#多核相关接口>`__ `49 <#多核相关接口>`__

`3 数据结构 <#数据结构>`__ `51 <#数据结构>`__

`4 典型调用流程图 <#典型调用流程图>`__ `67 <#典型调用流程图>`__

`4.1 典型调用流程图 <#典型调用流程图-1>`__ `67 <#典型调用流程图-1>`__

`4.2 典型流程 <#典型流程>`__ `67 <#典型流程>`__

`4.2.1 设置芯片型号 <#设置芯片型号>`__ `67 <#设置芯片型号>`__

`4.2.2 设置log等级 <#设置log等级>`__ `68 <#设置log等级>`__

`4.2.3 初始化数据结构 <#初始化数据结构>`__ `68 <#初始化数据结构>`__

`4.2.4 打开RNE设备 <#打开rne设备>`__ `68 <#打开rne设备>`__

`4.2.5 初始化网络模型 <#初始化网络模型>`__ `68 <#初始化网络模型>`__

`4.2.6 填充网络输入数据 <#填充网络输入数据>`__
`69 <#填充网络输入数据>`__

`4.2.7 网络推理 <#网络推理>`__ `69 <#网络推理>`__

`4.2.8 dump输出数据 <#dump输出数据>`__ `69 <#dump输出数据>`__

`4.2.9 释放网络 <#释放网络>`__ `70 <#释放网络>`__

`4.2.10 关闭RNE设备 <#关闭rne设备>`__ `70 <#关闭rne设备>`__

`5 重点问题说明 <#重点问题说明>`__ `70 <#重点问题说明>`__

`5.1 存储格式介绍 <#存储格式介绍>`__ `70 <#存储格式介绍>`__

`5.1.1 BLOB_N_H_W_Cstride格式 <#blob_n_h_w_cstride格式>`__
`70 <#blob_n_h_w_cstride格式>`__

`5.1.2 BLOB_N_H_W_C格式 <#blob_n_h_w_c格式>`__
`71 <#blob_n_h_w_c格式>`__

`5.1.3 INT_NHWC格式 <#int_nhwc格式>`__ `71 <#int_nhwc格式>`__

`5.2 如何设置输入数据 <#如何设置输入数据>`__ `72 <#如何设置输入数据>`__

`5.2.1 设置输入数据的方式 <#设置输入数据的方式>`__
`72 <#设置输入数据的方式>`__

`5.2.2
输入数据类型与eInputType对应关系 <#输入数据类型与einputtype对应关系>`__
`72 <#输入数据类型与einputtype对应关系>`__

`5.3 如何解析输出数据 <#如何解析输出数据>`__ `73 <#如何解析输出数据>`__

`5.4 SDK中的BLOBS mem <#sdk中的blobs-mem>`__ `74 <#sdk中的blobs-mem>`__

`5.5 网络权重对齐方式 <#网络权重对齐方式>`__ `74 <#网络权重对齐方式>`__

`5.6
设置网络blobs和权重地址为物理地址 <#设置网络blobs和权重地址为物理地址>`__
`75 <#设置网络blobs和权重地址为物理地址>`__

`5.7 onceload网络推理的注意点 <#onceload网络推理的注意点>`__
`76 <#onceload网络推理的注意点>`__

`6 samples说明 <#samples说明>`__ `76 <#samples说明>`__

`7 部署 <#部署>`__ `77 <#部署>`__

`7.1 PC模拟 <#pc模拟>`__ `77 <#pc模拟>`__

`7.1.1 相关文件说明 <#相关文件说明>`__ `77 <#相关文件说明>`__

`7.1.2 重要步骤说明 <#重要步骤说明>`__ `77 <#重要步骤说明>`__

`7.1.3 samples运行说明 <#samples运行说明>`__ `78 <#samples运行说明>`__

`7.2
TX5368x_TX5339x_TX5335x系列板端部署 <#tx5368x_tx5339x_tx5335x系列板端部署>`__
`79 <#tx5368x_tx5339x_tx5335x系列板端部署>`__

`7.2.1 配置交叉编译环境 <#配置交叉编译环境>`__
`79 <#配置交叉编译环境>`__

`7.2.2 编写应用程序main.c <#编写应用程序main.c>`__
`80 <#编写应用程序main.c>`__

`7.2.3 交叉编译生成板端部署资源 <#交叉编译生成板端部署资源>`__
`80 <#交叉编译生成板端部署资源>`__

`7.2.4 打开部署工具 <#打开部署工具>`__ `80 <#打开部署工具>`__

`7.2.5 拷贝部署资源到板端部署 <#拷贝部署资源到板端部署>`__
`80 <#拷贝部署资源到板端部署>`__

`7.3 TX510x系列板端部署 <#tx510x系列板端部署>`__
`81 <#tx510x系列板端部署>`__

`7.3.1 环境准备 <#环境准备>`__ `81 <#环境准备>`__

`7.3.2 配置交叉编译环境 <#配置交叉编译环境-1>`__
`81 <#配置交叉编译环境-1>`__

`7.3.3 编写应用程序main.c <#编写应用程序main.c-1>`__
`82 <#编写应用程序main.c-1>`__

`7.3.4 交叉编译生成板端部署资源 <#交叉编译生成板端部署资源-1>`__
`82 <#交叉编译生成板端部署资源-1>`__

`7.3.5 打开串口调试工具 <#打开串口调试工具>`__
`82 <#打开串口调试工具>`__

`7.3.6 拷贝部署资源到板端部署 <#拷贝部署资源到板端部署-1>`__
`82 <#拷贝部署资源到板端部署-1>`__

`7.4
TX5215x_TX5239x200_TX5239x220_TX5239x300系列板端部署 <#tx5215x_tx5239x200_tx5239x220_tx5239x300系列板端部署>`__
`83 <#tx5215x_tx5239x200_tx5239x220_tx5239x300系列板端部署>`__

`7.5 TX5112x_TX5239x201系列板端部署 <#tx5112x_tx5239x201系列板端部署>`__
`83 <#tx5112x_tx5239x201系列板端部署>`__

`7.6 TX5336x_TX5256x 板端部署 <#tx5336x_tx5256x-板端部署>`__
`84 <#tx5336x_tx5256x-板端部署>`__

`8 FAQ <#faq>`__ `84 <#faq>`__

`8.1 bin2header如何使用？ <#bin2header如何使用>`__
`84 <#bin2header如何使用>`__

`8.2 驱动rne_driver.ko如何加载？ <#驱动rne_driver.ko如何加载>`__
`85 <#驱动rne_driver.ko如何加载>`__

`8.3
rne_simple_forward示例中输出结果的宏开关如何使用？ <#rne_simple_forward示例中输出结果的宏开关如何使用>`__
`85 <#rne_simple_forward示例中输出结果的宏开关如何使用>`__

`8.4
CMakeList与Makefile中连接库有哪些注意事项？ <#cmakelist与makefile中连接库有哪些注意事项>`__
`85 <#cmakelist与makefile中连接库有哪些注意事项>`__

`8.5 SDK接口调用性能优化建议？ <#sdk接口调用性能优化建议>`__
`86 <#sdk接口调用性能优化建议>`__

`8.6 板端常见问题如何解决？ <#板端常见问题如何解决>`__
`87 <#板端常见问题如何解决>`__

`8.7 RNE运行时内存查看工具？ <#rne运行时内存查看工具>`__
`88 <#rne运行时内存查看工具>`__

`8.8 SDK使用注意事项？ <#sdk使用注意事项>`__ `88 <#sdk使用注意事项>`__
...
+---------------+------------------------------------------------------+
| scripts       | b                                                    |
|               | in2header实现二进制文件到头文件的转化。详细用法见FAQ |
+---------------+------------------------------------------------------+
|               | rne_e2e_example.sh                                   |
|               | 执行典型sample的脚本，关联sample为rne_simple_forward |
+---------------+------------------------------------------------------+
...
4. TS_SIZE_T virAddr = TS_MPI_TRP_RNE_PhysicalToVirtualAddress(phyAddr);
...
【定义】
   ...
   TS_S32 TS_MPI_TRP_RNE_AsyncExecutorBind(RNE_ASYNC_EXECUTOR
   \*asyncEtr,
...
|C:\\Users\\xiehao\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.Word\\企业微信截图_17319140062066.png|
...
|C:\\Users\\xiehao\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.Word\\企业微信截图_17319140366870.png|
...
1. **static** unsigned **char** \__attribute\_\_((aligned(4))) modelWeight[] = {  
...
~~~~~~~~~~~~~~~~~~
   ...
   参见\ `章节7.1.2 <#重要步骤说明>`__\ 。

交叉编译生成板端部署资源
~~~~~~~~~~~~~~~~~~~~~~~~

   参见\ `章节7.1.3 <#samples运行说明>`__\ 。
...
参考\ `7.2章节 <#tx5368x_tx5339x_tx5335x系列板端部署>`__\ 。
...
.. |image9| image:: media/image15.png
   :width: 4.64167in
   :height: 1.03264in
.. |IMG_256| image:: media/image16.png
   :width: 6.5625in
   :height: 1.30208in
.. |C:\\Users\\xiehao\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.Word\\企业微信截图_17319140062066.png| image:: media/image17.png
   :width: 6.63611in
   :height: 2.55486in
.. |C:\\Users\\xiehao\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.Word\\企业微信截图_17319140366870.png| image:: media/image18.png
   :width: 6.69375in
   :height: 2.28333in
.. |222222| image:: media/image24.png
   :width: 2.99653in
   :height: 1.89583in
.. |1111111| image:: media/image25.png
   :width: 3.51042in
   :height: 3.45069in
...
.. |image13| image:: media/image30.png
   :width: 4.5082in
   :height: 1.33739in
.. |image14| image:: media/image31.png
   :width: 4.80208in
   :height: 2.45903in
.. |1| image:: media/image32.png
   :width: 5.02594in
   :height: 1.17759in
...
.. |image19| image:: media/image37.png
   :width: 5.62389in
   :height: 3.57454in
.. |image20| image:: media/image38.png
   :width: 3.04167in
   :height: 2.64583in
